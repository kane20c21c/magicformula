...
`p ≥ 0.925` 이고 `rank ≤ 15` 인 종목까지만 충원하고, 5슬롯을 못 채우면 비워둔다.
...
- **세트 정의**: `src/gauge_config.py` (Kane 편집 파일 — **10세트 75종목**, 2026-08-15
  ...
  - ⚠ **유니버스 밖 6종목** (2026-08-15 현재 집계 제외 — Kane 이 편입 작업 별도 진행):
    098460 고영 · 323280 태성 · 083650 비에이치아이 · 051600 한전KPS ·
    090360 로보스타 · 160190 하이젠알앤엠. LLV core/extend 와
    `ticker_classification.json` 모두 미등재. 편입되면 코드 수정 없이 자동 반영.
