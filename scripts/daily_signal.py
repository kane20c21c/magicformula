...
# ---------------------------------------------------------------------------
# 종목명 Fallback (parquet의 Name 컬럼이 None인 경우 사용)
# ---------------------------------------------------------------------------
...
TICKER_NAMES: dict[str, str] = {
    ...
    "005290": "동진쎄미켐",       "000150": "두산",              "007660": "이수페타시스",
    "095340": "ISC",              "058610": "에스피지",          "277810": "레인보우로보틱스",
    "108490": "로보티즈",         "454910": "두산로보틱스",       "348340": "뉴로메카",
    "056080": "유진로봇",         "010120": "LS ELECTRIC",       "298040": "효성중공업",
    "267260": "HD현대일렉트릭",   "001440": "대한전선",          "000720": "현대건설",
    "047040": "대우건설",         "034020": "두산에너빌리티",     "052690": "한전기술",
    "032820": "우리기술",         "373220": "LG에너지솔루션",    "006400": "삼성SDI",
    "005490": "POSCO홀딩스",      "247540": "에코프로비엠",       "051910": "LG화학",
    "086520": "에코프로",         "068270": "셀트리온",          "196170": "알테오젠",
    "207940": "삼성바이오로직스", "0126Z0": "KODEX코스닥150",    "329180": "HD현대중공업",
    "042660": "한화오션",         "010140": "삼성중공업",        "012450": "한화에어로스페이스",
    "047810": "한국항공우주",     "064350": "현대로템",          "272210": "한화시스템",
    "079550": "LIG넥스원",        "055550": "신한지주",          "086790": "하나금융지주",
    "105560": "KB금융",           "316140": "우리금융지주",       "006800": "미래에셋증권",
    "071050": "한국금융지주",     "016360": "삼성증권",          "039490": "키움증권",
...
def run(target_date: str | None = None) -> dict:
    ...
    for i, ticker in enumerate(tickers, 1):
        ...
        raw_name = latest.get("Name")
        name = (str(raw_name) if raw_name and str(raw_name) not in ("None", "nan", "NaN", "")
                else TICKER_NAMES.get(ticker, ticker))
